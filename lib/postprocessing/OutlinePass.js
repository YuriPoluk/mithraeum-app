...
export default class OutlinePass extends Pass {
	...
	render( renderer, writeBuffer, readBuffer, deltaTime, maskActive ) {
		...
		if ( this.selectedObjects.length > 0 ) {
			...
			//overriding material means banner with custom shader which uses transparent texture for defining cloth shape won't be transparent
			// anymore which leads to undesired look. Not Using maskMaterial breaks some functionality of OutlinePass which we don't need anyway
			this.renderScene.overrideMaterial = this.isFlagSelected ? null : this.prepareMaskMaterial;
		...
		return new ShaderMaterial( {
			...
			vertexShader:
				...
				void main() {
					...
					mat4 scale = mat4(2.0, 0.0, 0.0, 0.0,  // 1. column
									 0.0, 2.0, 0.0, 0.0,  // 2. column
									 0.0, 0.0, 2.0, 0.0,  // 3. column
									 0.0, 0.0, 0.0, 1.0); 
